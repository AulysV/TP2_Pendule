...
class ODESolver:
    ...
    def solve(self, u0, temps, dt):
        ...
        for n in range(1, N):
            ...
            t_rest = tf - self.t
            msg2 = "Error in time calculation t_rest should be positive"
            assert t_rest > -dt, msg2
            msg3 = "Error in time calculation t_rest should be smaller than dt"
            assert t_rest < dt, msg3
